...
# PASS PHRASE : TOTO
os.system(CHEMIN_ACCES_OPENSSL+" req -x509 -config root-ca-cert.cnf -newkey rsa:2048 -out ca.pem -keyout private/private.pem -days 1826")
...
os.system("openssl dgst -sha256 -passin pass:toto -sign gestionCertificat/private/private.pem -out sha256.sign code.txt")
